...
- Accedera alla sezione "Classifica" per visualizzare la propria posizione 
...
_NB: Ogni lettera rappresenta una soluzione diversa_
...
Scelta dell'agente (si consiglia Docker).
 ...
 _PASSO A.4_:
Inserire il comando nel prompt sostituendo il _token_ e il _dominio statico_ fornito:
