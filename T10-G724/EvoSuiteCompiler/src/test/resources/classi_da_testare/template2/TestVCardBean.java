...
public class TestVCardBean {
	...
	// Test errato: testGetVCardWithData ma senza email impostata
    @Test
    public void testGetVCardWithDataMissingEmail() {
        vCardBean.setFirstName("John");
        vCardBean.setLastName("Doe");
        vCardBean.setOrganization("XYZ Company");
        // Non impostiamo l'email per simulare un errore
        // vCardBean.setEmail("john.doe@example.com"); // Commentato per creare un errore
        assertNotNull(vCardBean.getVCard()); // Ci aspettiamo un fallimento qui, dovrebbe restituire null
    }
}