...
public class TestVCardBean {
    ...
    // Test malformato: confrontiamo il cognome impostato con un valore errato
    @Test
    public void testSetAndGetLastName() {
        vCardBean.setLastName("Doe");
        assertEquals("Smith", vCardBean.getLastName()); // Malformazione: ci aspettiamo "Smith" ma abbiamo impostato "Doe"
    }
