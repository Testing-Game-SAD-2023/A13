 ...
 */
public class GameModeDontExistException extends RuntimeException {

    // Costruttore che accetta un messaggio di errore
    public GameModeDontExistException(String message) {
    ...
    public GameModeDontExistException(String message, Throwable cause) {
