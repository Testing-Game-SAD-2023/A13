...
public class TeamService {
    ...
    public ResponseEntity<?> createTeam(Team team, String adminEmail) {
	...
	if (adminEmail == null || adminEmail.isEmpty()) {
        ...
        if (teamToDelete.getAdmin() == null || !teamToDelete.getAdmin().getEmail().equals(adminEmail)) {
