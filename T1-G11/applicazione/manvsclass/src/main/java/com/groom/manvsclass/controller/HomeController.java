...
import com.groom.manvsclass.responses.Response;
...
import com.groom.manvsclass.service.ClassService;
...
// Si potrebbe specificare in @CrossOrigin(origins = {"indirizzo1", "indirizzo2", ... }) chi può usare certi endpoint
// Si potrebbe usare @RestController per evitare di scrivere sempre @ResponseBody
// Si potrebbero separare i Controller di Admin e ClassUT
...
public class HomeController {
    ...
    public ResponseEntity<List<String>> getRobots(HttpServletRequest request,
        ...
        return adminService.getRobots(request, jwt);
    }

    @GetMapping("/home_adm")
    public ModelAndView showHomeAdmin(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    public ModelAndView showModificaClasse(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
        return adminService.showModificaClasse(request, jwt);
    }

    @GetMapping("/uploadClasse")
    public ModelAndView showUploadClasse(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
        return adminService.showUploadClasse(request, jwt);
    }

    @GetMapping("/uploadClasseAndTest")
    public ModelAndView showUploadClasseAndTest(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
        return adminService.showUploadClasseAndTest(request, jwt);
    }

    @GetMapping("/reportClasse")
    public ModelAndView showReportClasse(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    @ResponseBody
    public ResponseEntity<List<ClassUT>> filtraClassi(@PathVariable String text, @PathVariable String category,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    @ResponseBody
    public ResponseEntity<List<ClassUT>> elencaClassiD(@PathVariable String text, @PathVariable String difficulty,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    // MODIFICA (20/02/2024) : Eliminazione della riga riguardante il caricamento
    // dei relativi test generati dai Robot (ATTENZIONE)
    @PostMapping("/uploadFile")
    @ResponseBody
    public ResponseEntity<FileUploadResponse> uploadFile(@RequestParam("file") MultipartFile classFile,
            @RequestParam("model") String model, @CookieValue(name = "jwt", required = false) String jwt,
    ...
    public ResponseEntity<FileResponse> uploadTest(
            @RequestParam(name = "file", required = false) MultipartFile classFile,
            @RequestParam("model") String modelJSON,
            @RequestParam Map<String, MultipartFile> testFiles,
            @CookieValue(name = "jwt", required = false) String jwt,
            HttpServletRequest request) throws IOException {
    ...
    public ModelAndView showChangePswAdminForm(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    public ModelAndView showResetPswAdminForm(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    @ResponseBody
    public ModelAndView showInviteAdmins(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    @ResponseBody
    public ModelAndView showLoginWithInvitationForm(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    // MODIFICA (17/04/2024) : Aggiunta pagina di configurazione della nuova
    // modalità di gioco
    @GetMapping("/scalata")
    public ModelAndView showGamePageScalata(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    public ResponseEntity<?> uploadScalata(@RequestBody Scalata scalata,
            @CookieValue(name = "jwt", required = false) String jwt, HttpServletRequest request) {
        return scalataService.uploadScalata(scalata, jwt);
    }

    // MODIFICA (15/05/2024) : Recupero di tutte le "Scalate" memorizzate nel
    // sistema
    ...
    // MODIFICA (16/05/2024) : Rimozione di una specifica "Scalata" memorizzata nel
    // sistema
    ...
    // MODIFICA (15/05/2024) : Recupero di una specifica "Scalata" memorizzata nel
    // sistema
    ...
    public ModelAndView showAchievementsPage(HttpServletRequest request,
            @CookieValue(name = "jwt", required = false) String jwt) {
    ...
    public Object createAchievement(Achievement achievement, @CookieValue(name = "jwt", required = false) String jwt,
    ...
    public Object createStatistic(Statistic statistic, @CookieValue(name = "jwt", required = false) String jwt,
            HttpServletRequest request) {
        return achievementService.createStatistic(statistic, jwt, request);
    }

    @DeleteMapping("/statistics/{Id}")
    public Object deleteStatistic(@PathVariable("Id") String Id,
            @CookieValue(name = "jwt", required = false) String jwt, HttpServletRequest request) {
    ...
    public ResponseEntity<String> loginAdmin(@RequestBody Admin admin1,
            @CookieValue(name = "jwt", required = false) String jwt, HttpServletResponse response) {
