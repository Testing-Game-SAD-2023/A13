...
public class RobotUtil {
	 ...
	 */
	public static void generateAndSaveRobots(String fileName, String className, MultipartFile classFile)
			throws IOException {
	...
	public static void saveRobots(String fileNameClass, String fileNameTest, String fileNameTestEvo, String className,
			MultipartFile classFile, MultipartFile testFile, MultipartFile testFileEvo)
			throws IOException {
		...
		if (testFile != null) {
			...
			// Rinomina il file zip caricato secondo la convenzione attuale:
			// |nomeClasse|TestRandoop.zip
			...
			String nuovoNome = "/VolumeT9/app/FolderTree/" + className + "/RobotTest/RandoopTest/" + className
					+ "TestRandoop.zip";
			...
			String zipRandoop = "/VolumeT9/app/FolderTree/" + className + "/RobotTest/RandoopTest/" + className
					+ "TestRandoop.zip";
			...
			Files.delete(Paths.get("/VolumeT9/app/FolderTree/" + className + "/RobotTest/RandoopTest/" + className
					+ "TestRandoop.zip"));
		...
		if (testFileEvo != null) {
			...
			String nuovoNomeEvo = "/VolumeT8/FolderTreeEvo/" + className + "/RobotTest/EvoSuiteTest/" + className
					+ "TestEvosuite.zip";
			...
			String zipEvo = "/VolumeT8/FolderTreeEvo/" + className + "/RobotTest/EvoSuiteTest/" + className
					+ "TestEvosuite.zip";
			File destEvo = new File("/VolumeT8/FolderTreeEvo/" + className + "/RobotTest/EvoSuiteTest");
			RobotUtil.unzip(zipEvo, destEvo);
			// Elimina la zip dei test
			Files.delete(Paths.get("/VolumeT8/FolderTreeEvo/" + className + "/RobotTest/EvoSuiteTest/" + className
					+ "TestEvosuite.zip"));
		...
		if (testFile != null) {
			...
			for (File result : results) {
				...
				System.out.println(
						"La copertura del livello " + String.valueOf(livello) + " è: " + String.valueOf(score));
