...
public class TestVCardBean {
   ...
   // Test malformato: ci aspettiamo che getVCard() restituisca null, ma verifichiamo il contrario
    @Test
    public void testGetVCardWithoutData() {
        assertNotNull(vCardBean.getVCard()); // Malformazione: ci aspettiamo null, ma verifichiamo che non sia null
