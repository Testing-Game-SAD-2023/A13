...
public class TimeStamp implements java.io.Serializable, Comparable<TimeStamp> {
	...
	//Controlla se i metodi non annotati non vengono eseguiti correttamente.
	 @Test
    public void metodoAnnotato() {
        System.out.println("Questo metodo è annotato e dovrebbe essere eseguito.");
    }

    public void metodoNonAnnotato() {
        System.out.println("Questo metodo NON è annotato e non dovrebbe essere eseguito.");
    }
